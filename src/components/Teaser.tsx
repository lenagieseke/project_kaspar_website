...
export default function Teaser({ text }: { text: string }) {
  ...
  useEffect(() => {
    ...
    import('matter-js').then((Matter) => {
      ...
      // Remove wheel listeners that Matter.js adds by default; they call
      // preventDefault and block native page scrolling.
      // @types/matter-js omits these event handler references; cast to access them
